...
const readTransaction = async (
    ...
    try {
        ...
        // let dynamic value (dapat dirubah nilainya)
        // const nilai tetap
...
const delaeteTransaction = async (req: Request, res: Response) => {
    try {
        const { id } = req.params
        ...
        // hapus detail transaksi dulu, krn detail transaksi adalah tabel yg tergantung pada tabel transaksi
...
const updateTransaction = async (req: Request, res: Response) => {
    try {
        // read id transaction from req.param
        const { id } = req.params
        ...
        return res.status(200).json({ message: `New Transaction has updated` })
...
export { createTransaction, readTransaction, delaeteTransaction, updateTransaction }